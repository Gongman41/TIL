...
def get_movie_datas(movie_lst):
    total_data = []
    for movie_title in movie_lst:
        headers = {
            "accept": "application/json",
            "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyZjA4ZjI1ZDJhOTljOTAwNGU5MGViNDg0NTNiYjJlNCIsInN1YiI6IjY2M2Q2NWMxNjM2NzllZjlhMGQ5ZTNjZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ._ZVCz0YUwuPuoio-DtTn2384JSPeWPywopvxnwtJB_I",
        }
        params = {
            'query': movie_title,
            'language': 'ko-KR'
        ...
        movies = requests.get(url, headers=headers, params=params).json()
        print(movies)
